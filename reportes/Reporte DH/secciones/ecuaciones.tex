...
\begin{itemize}
	...
	\begin{figure}[h]
		\centering
		\subfloat[Sensor]{%
			\includegraphics[width=5 cm]{img/gir1}%
			\label{fig:Sensor}
		}
		\hfill
		\subfloat[Fisico]{%
			\includegraphics[width=5 cm]{img/gir2}%
			\label{fig:Fisico}
		}
...
\begin{itemize}
	...
	\centering
	\subfloat[De flujo]{%
		\includegraphics[width=6 cm]{img/mag1}%
		\label{fig:mag1}
	}
	\hfill
	\subfloat[De efecto Hall]{%
		\includegraphics[width=6 cm]{img/mag2}%
		\label{fig:mag2}
	}
...
\begin{itemize}
	...
	\begin{figure}[h]
	\centering
	\subfloat[Fotometria Lidar]{%
		\includegraphics[width=7 cm]{img/lida1}%
		\label{fig:lida1}
	}
	\hfill
	\subfloat[Drone Lidar]{%
		\includegraphics[width=7 cm]{img/lida2}%
		\label{fig:lida2}
	}
