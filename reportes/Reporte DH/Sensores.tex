\label{key}\documentclass[journal,12pt,onecolumn]{IEEEtran}
...
\input{secciones/robot 2}
\input{secciones/robot 4}
\input{secciones/robot 6}
\input{secciones/robot 10}
\input{secciones/robot 13}
